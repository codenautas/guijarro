...
function guijarro(targetDiv, centerZone) {
    var template = {
        strokeColor: "#0000FF",
        strokeOpacity: 1,
        strokeWidth: 3,
    ...
    var UbicateControl = /** @class */ (function (_super) {
        __extends(UbicateControl, _super);
        function UbicateControl(opt_options) {
            var _this = this;
    ...
    function mark(lat, long, abr, title, className) {
        var element = document.createElement("div");
    ...
    function addLayer(url, style) {
        ...
        var vector = new ol.layer.Vector({ map: map, source: source, style: style || globalKmlStyle });
    ...
    return { addMark: mark, addLayer: addLayer, posiciones: posiciones };
}
